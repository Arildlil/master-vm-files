...
*/
/*
static int __init test_xarray_rewrite_init(void)
{
	add_tests();
	return 0;
}
static void __exit test_xarray_rewrite_exit(void)
{
	KTF_CLEANUP();
}
*/
...
/* ADDED KTF */
/*
module_init(test_xarray_rewrite_init);
module_exit(test_xarray_rewrite_exit);
*/
/* DONE */
